CC ?= clang
CFLAGS = -Ofast -Wno-unused-result -Wno-ignored-pragmas -Wno-unknown-attributes -g -DHAVE_LINUX_PERF_EVENT_H
LDFLAGS =
LDLIBS = -lm
INCLUDES =
...
# Add targets
TARGETS = train_gpt2 test_gpt2 my_train_gpt2 my_test_gpt2
...
train_gpt2: train_gpt2.h train_gpt2.c perfstats.o
	$(CC) $(CFLAGS) $(OPT_CFLAGS) $(INCLUDES) $(LDFLAGS) $^ $(LDLIBS) $(OUTPUT_FILE)
    
my_train_gpt2: my_train_gpt2.h my_train_gpt2.c perfstats.o
	$(CC) $(CFLAGS) $(OPT_CFLAGS) $(INCLUDES) $(LDFLAGS) $^ $(LDLIBS) $(OUTPUT_FILE)

test_gpt2: train_gpt2.h test_gpt2.c perfstats.o
	$(CC) $(CFLAGS) $(OPT_CFLAGS) $(INCLUDES) $(LDFLAGS) $^ $(LDLIBS) $(OUTPUT_FILE)

my_test_gpt2: my_train_gpt2.h my_test_gpt2.c perfstats.o
	$(CC) $(CFLAGS) $(OPT_CFLAGS) $(INCLUDES) $(LDFLAGS) $^ $(LDLIBS) $(OUTPUT_FILE)
